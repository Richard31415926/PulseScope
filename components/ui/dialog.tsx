...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "surface-elevated fixed top-[50%] left-[50%] z-50 w-[min(96vw,720px)] translate-x-[-50%] translate-y-[-50%] rounded-[28px] border border-white/10 p-0 shadow-2xl outline-none",
        className,
      )}
      {...props}
    >
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-sm leading-6 text-white/56", className)}
    {...props}
  />
));
